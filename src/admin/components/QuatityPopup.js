  ...
  return (
    <div
      ...
      className={
        ...
        ?"fixed h-full left-0 right-0 z-50  p-4 bg-black bg-opacity-20 overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full"
    ...
    >
      <div className="py-12 lg:absolute lg:left-1/3 lg:right-1/3 lg:top-1/3 lg:bottom-1/3 w-full max-w-md max-h-full">
